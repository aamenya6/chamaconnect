    ...
    <div className="min-h-screen">
      ...
      >
        ...
        <div className="mx-auto max-w-6xl px-4 py-3 flex items-center gap-3">
          {/* Logo (LEFT) */}
          <Link to="/" className="font-semibold tracking-wide shrink-0">
      ...
      <footer className="mt-16 border-t border-white/10">
        <div className="mx-auto max-w-7xl px-4 py-6 flex items-center justify-between text-sm text-white/60">
          <span>© 2026 ChamaConnect</span>

          <span className="text-right">A gateway to transparent savings</span>
        </div>
      </footer>
    </div>
  );
